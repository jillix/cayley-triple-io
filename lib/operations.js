...
exports.create = function (options) {
    ...
    function writeTriple (chunk, encoding, next) {
        ...
        // parse chunk
        var triple = utils.parseTriple(chunk, self.prefixes);

        self._cayleyClient.write([triple], function (err, res) {
...
exports.delete = function (options) {
    ...
    function writeTriple (chunk, encoding, next) {
        ...
        self._cayleyClient.delete([triple], function (err, res) {
